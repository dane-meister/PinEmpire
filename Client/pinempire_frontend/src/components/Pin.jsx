...
const Pin = ({ pin: { postedBy, image, _id, destination, save } }) => {
  ...
  const imageUrlMobile = urlFor(image).width(250).url();
  const imageUrlDesktop = urlFor(image).width(800).url();
  ...
  return (
    <div className="m-2">
      ...
      <img 
        ...
        alt="user-post" 
        srcSet={`${imageUrlMobile} 250w, ${imageUrlDesktop} 800w`}
        sizes="(max-width: 600px) 250px, 800px" />
      {postHovered && (
        <div
